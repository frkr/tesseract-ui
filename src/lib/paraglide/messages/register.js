...
const pt_br_register = /** @type {(inputs: {}) => string} */ () => {
	return `Cadastrar`
};

const en_register = /** @type {(inputs: {}) => string} */ () => {
	return `Register`
};

const es_register = /** @type {(inputs: {}) => string} */ () => {
	return `Registrarse`
};
...
export const register = (inputs = {}, options = {}) => {
	...
	if (locale === "pt-br") return pt_br_register(inputs)
	if (locale === "en") return en_register(inputs)
	return es_register(inputs)
};